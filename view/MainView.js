    ...
    [
        ...
        return Controller.extend("add.ui.crud.MainView", {
            ...
            constructor: function (that) {
                ...
                if (!MainView.IDAPP)
                    MainView.IDAPP = MainView.getView().getController().getOwnerComponent().getManifest()["sap.app"].id;
                ...
                MainView._sortTable = this._sortTable;
                ...
                if (!that.checkContext) that.checkContext = this.checkContext;
                if (!that.obligatoryCheck) that.obligatoryCheck = this.obligatoryCheck;
                ...
                that.getView().byId(MainView.IDAPP).addPage(
            ...
            create: async function (data) {
                ...
                if (MainView.beforeCreating instanceof Function)
                    if (!MainView.beforeCreating(resp, MainView)) return;
                ...
                let opl = new sap.uxap.ObjectPageLayout({
                    ...
                    /*        headerTitle:
                               new sap.uxap.ObjectPageHeader({
                                   navigationBar: Bar,
                                   objectImageURI: MainView.icon || "sap-icon://approvals",
                                   isObjectTitleAlwaysVisible: true,
                                   showPlaceholder: true,
                                   isObjectIconAlwaysVisible: true,
                                   objectTitle: MainView.title,
                                   objectSubtitle: MainView.subtitle,
                                   actions: []//panel
            ...
            obligatoryCheck: function () {
                ...
                function checkByData(data) {
                    ...
                    let obl = MainView.fieldcat.filter(f => f.obligatory === true);
                    let check = true;
