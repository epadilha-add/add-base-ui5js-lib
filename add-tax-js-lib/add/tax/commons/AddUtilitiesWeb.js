sap.ui.define(["../add/AddUtilities"], function (AddUtilities) {
    ...
    return {
        ...
        callAddtaxSAP: async function (body, callbackFunctionSucess, callbackFunctionError, that, METHOD) {
            ...
            if (vmethod === "GET") {
                ...
                if (window.location.origin === "http://localhost:5001") {
                    ...
                    var url = "/api/ADDTAX-ECC-SERVICE/addservice/masterdata?context=" + window.btoa(body);
                }
                ...
                if (window.location.origin === "http://localhost:5001") {
                    ...
                    var url = "/api/ADDTAX-ECC-SERVICE/addservice/masterdata";
                    header = {
                        "Content-Type": "application/json"
                    }
                }
