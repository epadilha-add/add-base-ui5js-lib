sap.ui.define(["../commons/AddModels", "sap/ui/model/json/JSONModel", "sap/ui/core/format/DateFormat", "sap/base/Log",], function (AddModels, JSONModel, DateFormat, Log) {
    ...
    var oMessageView = {};
    var oPopover = {};
    return sap.m.Button.extend("add.tax.ui.Notification", {
        ...
        modelStart() {
            ...
            if (!oModel) {
                ...
                oModel.loadData("add/tax/config/" + AddModels.IDAPP || "", null, false);
        ...
        startNotificationArea: function () {
            ...
            var oLink = new sap.m.Link({
                text: "{i18n>showMore}",
                href: window.location.origin + "/add/tax/notification/{uuid}",
                target: "_blank"
            });
